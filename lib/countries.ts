...
export const COUNTRIES: Country[] = [
  ...
  { name: "Korea, North", dial_code: "+850", code: "KP", flag: "🇰🇵" },
  ...
  { name: "Vatican City State", dial_code: "+379", code: "VA", flag: "🇻🇦" },
  ...
  { name: "Wallis and Futuna Islands", dial_code: "+681", code: "WF", flag: "🇼🇫" },
