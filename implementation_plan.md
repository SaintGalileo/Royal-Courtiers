...
The goal is to update the application with the official event itinerary and competition schedules as provided in the handwritten notes. This involves updating multiple pages to ensure all dates and events are accurate and consistent. For over-detailed descriptions in the handwritten notes, I will summarize them for the application or add an info icon to display the full description upon hover for desktop and upon click for mobile.
...
- Update `MOCK_MATCHES` to include:
  - **Debate**:
    ...
    - July 22: 3rd Place.
    - Aug 16: Finals.
  - **Essay Writing**: Aug 10 (Topic Announcement after Morning Devotion; essay to be submitted on or before 10 a.m. Aug 12).
  - **Quiz / Spelling Bee**: Aug 12 (Pageantry Phase 1).
  - **Pageantry**:
    - Aug 12: Phase 1.
    - Aug 15: Phase 2. (Cultural Day).
