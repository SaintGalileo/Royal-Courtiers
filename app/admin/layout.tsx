...
export default function AdminLayout({
  ...
  const menuItems = [
    ...
    { label: "Anniversary T-Shirts", href: "/admin/t-shirts", icon: Shirt },
    {
      label: "Sacred Records",
      href: "/admin/sacred-records",
      icon: ScrollText,
    },
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 transform border-r border-zinc-200 bg-white shadow-xs transition-transform duration-300 dark:border-zinc-800 dark:bg-zinc-900 sm:sticky sm:top-0 sm:h-screen sm:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
