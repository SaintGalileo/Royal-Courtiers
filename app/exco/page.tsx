...
function getInitials(name: string) {
  ...
  // For "Brother Clinton Uwe Same", we might want the first letter of first name and last name
...
const topExcos = [
  {
    role: "Int'l President",
    name: "Brother Clinton Uwe",
    delay: "0ms",
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774990466/photo_2026-03-31_21-50-43_nexqtr.jpg",
  },
  {
    role: "Vice President",
...
const otherExcos = [
  ...
  { role: "Financial Secretary", name: "Sister Promise Umaheyo", img: null },
  {
    ...
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774983130/photo_2026-03-31_19-46-15_hb3x57.jpg",
  },
  {
    role: "Office Administrator",
    name: "Sister Blessing Daniel",
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774983128/photo_2026-03-31_19-46-18_qoebkl.jpg",
  },
  {
  ...
  },
  {
    ...
    name: "Sister Sarah Eko",
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774984556/photo_2026-03-31_20-15-43_acjio9.jpg",
  },
  {
    role: "Choirmaster General",
  ...
  { role: "Mother 2", name: "Brother Victor Omolu", img: null },
  {
    ...
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774985268/photo_2026-03-31_20-28-01_e7cuuc.jpg",
  },
  {
  ...
  { role: "Caretaker 2", name: "Brother Gabriel George", img: null },
  {
    ...
    img: "https://res.cloudinary.com/dgmo4mkhk/image/upload/v1774983136/photo_2026-03-31_19-46-22_eem4yd.jpg",
  },
  {
    role: "Event Director",
...
export default function ExcoPage() {
  return (
    <main className="min-h-screen w-full bg-background text-foreground flex flex-col font-[family-name:var(--font-libre)]">
      <div className="flex-1 px-4 pt-18 max-w-6xl mx-auto w-full">
        {/* Header Section */}
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            The dedicated leaders overseeing the affairs of the 144,000 Virgins
            Body.
          </p>
        </div>
        ...
        <div className="mt-20 mb-10 flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 fill-mode-both">
