...
const ITINERARY: ItineraryDay[] = [
  {
    ...
    visibleItems: [
      ...
      {
        time: "08:00 AM",
        title: "Event Logo Presentation",
        location: "The Great Hall",
      },
      {
        time: "12:00 PM",
        title: "Unveiling of the Hall of Fame",
        location: "26 Mbukpa",
      },
      {
        time: "2:00 PM",
        title: "Scrabble, Chess and Ludo",
  ...
  },
  {
    ...
    visibleItems: [
      ...
      {
        time: "1:00 PM",
        title: "Sports Activites Phase 2",
  ...
  },
  {
    ...
    visibleItems: [
      {
        time: "08:00 AM",
        title: "Sports Activities (Finals)",
        location: "Bromco Field",
      },
      {
        time: "01:00 PM",
        title: "Debate, Quiz & Spelling Bee",
        location: "26 Mbukpa Holy Chapel",
      },
      {
        time: "05:00 PM",
        title: "Solo, Duet, Trio & Quartet",
        location: "26 Mbukpa Holy Chapel",
      },
    ],
  },
      ...
      <div className="mx-auto w-full max-w-6xl space-y-12">
        ...
        <header className="space-y-4 text-center md:text-left">
          ...
          {/* <p className="max-w-2xl text-lg text-zinc-600 dark:text-zinc-400">
            A week packed with spiritual encounters, family bonding, and grand
            celebrations. Note that some activities are kept secret until the
            day arrives.
          </p> */}
        </header>
