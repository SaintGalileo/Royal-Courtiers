...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You can log into your personalized dashboard using your Unique Access Code. Keep this code secure as it grants access to your profile, family tree, event schedules, and more. Note that access to this is exclusively for consecrated 144,000 Virgins.",
  },
  {
